...
### Git Standards
- ✅ **Обязательный запуск ПОЛНОГО набора тестов перед `git push`**
- ✅ **AI Assistant ОБЯЗАН запустить `npx vitest run` (или аналог) перед предложением запушить код**
- ❌ **ЗАПРЕЩЕНО** пушить код с упавшими тестами или без предварительной проверки
- ✅ Если тесты упали — сначала фиксим, потом пушим вновь
