    ...
    <div className="relative group p-[5px] rounded-[2.8rem] transition-all duration-500 hover:scale-[1.03] active:scale-[1.05] h-full">
      ...
      <div className="relative bg-white/90 backdrop-blur-xl rounded-[2.6rem] overflow-hidden flex flex-col h-full border border-white/40 shadow-xl group-hover:bg-white/95 transition-colors duration-500">
        ...
        >
          ...
          <div className="absolute bottom-4 right-4 bg-pink-500 text-white px-4 py-2 rounded-2xl font-bold shadow-lg transform group-hover:translate-y-[-4px] transition-transform duration-300">
        ...
        <div className="p-6 flex flex-col flex-grow">
          ...
          <div className="mt-auto space-y-3 relative">
            ...
            <button 
              ...
              disabled={isInCart}
              className={`block w-full text-center py-4 rounded-2xl font-black shadow-lg transition-all uppercase tracking-widest text-sm border-b-4 transform-gpu ${
                isInCart 
