            ...
            <div className="lg:w-2/5 p-8 lg:p-12 bg-gray-50/50 lg:border-l border-gray-100 flex flex-col">
              <div className="mb-8">
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <span className="text-gray-400 font-bold line-through text-xl opacity-50">${(product.price * 1.5).toFixed(2)}</span>
                </div>
              ...
              <div className="mt-10 space-y-8">
                ...
                <div className="relative space-y-4">
                   ...
                   <button 
                    ...
                    disabled={isInCart}
                    className={`w-full inline-flex items-center justify-center py-6 rounded-[2.5rem] font-black text-2xl shadow-2xl transition-all uppercase tracking-tight transform-gpu border-b-8 ${
                      isInCart 
